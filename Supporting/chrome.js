...
// visibility & Validation code start 

function setVisibility(id, visibility) {
document.getElementById(id).style.display = visibility;
}

function setVisibilityBg(id, visibilityBg) {
document.getElementById(id).style.display = visibilityBg;
}

function validate_form()
{
document.loginForm.txtUser.focus();
return false
}

function enbdib(sel, sel1, sel2)
{
...
// visibility & Validation  code End 